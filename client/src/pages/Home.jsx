...
const Home = () => {
  ...
  const [searchedReesults, setSearchedReesults] = useState(null)
  ...
  const handleSearchChange = (e) =>{
    ...
    setSearchTimeout(
      setTimeout(() =>{
        ...
        setSearchedReesults(searchResult)
      },500)
    )
  }
  ...
  return (
    <div className='max-w-7xl mx-auto'>
      ...
      <div className='mt-10'>
        ...
        <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grod-cols-2 grid-cols-1 gap-3'>
            {searchText ? (
              <RenderCards 
                data={searchedReesults}
