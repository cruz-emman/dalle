...
const CreatePost = () => {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <div className='mt-10'>
        <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created ther image you want, you can share it with others in the community</p>
        <button
          type="submit"
          className='mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'
        >{loading ? 'Sharing...' : "Shared with the community"}</button>
      </div>
